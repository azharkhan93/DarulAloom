...
const  Contact = () => {
  return (
    ...
    <div className="relative w-full h-[400px] bg-cover bg-center bg-black">
            <Image
                src="/child6.jpeg" // Replace with your image path
                    ...
                    <div className="-mx-4 flex flex-wrap lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <h2 className="mb-6 text-[32px] font-bold uppercase text-brwn sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                                        ...
                                        >
                                            ...
                                            <defs>
                                                <clipPath id="clip0_941_17577">
                                                    <rect width="32" height="32" fill="#964B00" />
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
