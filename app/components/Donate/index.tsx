...
const PromoSection1 = () => {
  ...
  <div className="relative py-16 sm:py-28 px-4 flex justify-center items-center bg-gradient-to-br from-gray-700 to-gray-900 h-[550px]">
    ...
    <div className="relative max-w-2xl flex flex-col justify-center items-center text-center z-10">
      {/* ::Title */}
      <h2 className="text-2xl sm:text-7xl md:text-4xl text-white font-extrabold tracking-wide">Support Our Cause</h2>
      {/* ::Text */}
      <p className="mt-3 lg:text-2xl sm:text-base text-white font-medium">Help us continue our noble mission to provide education and support to those in need. Your generous donations make a significant impact on the lives of many.</p>
      {/* ::Button */}
