    ...
    //   <div className="relative w-full overflow-hidden">
        <header className="  top-0 z-40 sticky w-full flex justify-center ">
          <nav className="absolute w-full  ">
            ...
            <div className="relative z-30 bg-gradient-to-b from-gray-900 to-gray-900 overflow-hidden">
...
>
  <span className="block text-white font-semibold">Donate Now</span>
                      ...
                      >
                        <span className="block text-green-600 dark:text-green-500 font-semibold">Login</span>
                      </button>
                    </div>
                  </div>
                </div>
