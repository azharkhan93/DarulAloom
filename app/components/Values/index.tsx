                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our Values & Objectives </p>
                                <p className="mt-6 text-lg leading-8 text-gray-600">We uphold the value of knowledge as a guiding light. We believe in the transformative power of education rooted in the teachings of the Quran and Sunnah. Our commitment to knowledge extends beyond academic excellence, fostering a deep understanding of Islamic principles and promoting lifelong learning</p>
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                    <div className="relative pl-9">
                                        <dt className="inline text-2xl text-gray-900">
